...
public class AuthenticationController {
    ...
    public MyResponseWrapper register(@Valid @RequestBody RegisterReqBody registerReqBody, @RequestAttribute(value = RequestAttributeFieldName.MY_REQ_CONTEXT) MyRequestContext myReqContext) {
    ...
    public MyResponseWrapper login(@Valid @RequestBody LoginReqBody loginReqBody, @RequestAttribute(value = RequestAttributeFieldName.MY_REQ_CONTEXT) MyRequestContext myReqContext) {
        return loginService.login(loginReqBody, myReqContext);
    }

    @PostMapping(path = ApiConst.Path.LOGIN_MFA_VERIFICATION)
    public MyResponseWrapper loginMFAVerification(@Valid @RequestBody LoginMFAVerificationReqBody loginMFAVerificationReqBody, @RequestAttribute(value = RequestAttributeFieldName.MY_REQ_CONTEXT) MyRequestContext myReqContext) {
    ...
    public MyResponseWrapper renewAccessToken(@Valid @RequestBody RenewAccessTokenReqBody renewAccessTokenReqBody, @RequestAttribute(value = RequestAttributeFieldName.MY_REQ_CONTEXT) MyRequestContext myReqContext) throws JwtException {
